...
const inViewport = (el, divided = 1) => {
  ...
  return (
    elementTop <=
    (window.innerHeight || document.documentElement.clientHeight) / divided
  );
};
...
/* 
TODO: 
- Get rid of all the junk in this file and the CSS file
- On search, h1 and description text disappears
- Take search content, make results appear
- Add search icon as people start typing
*/
