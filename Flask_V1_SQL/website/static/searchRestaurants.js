...
function renderRestaurantCards(data) {
  ...
  data.recommendations.forEach((restaurant) => {
      ...
      // Event listeners to scroll arrows with arrow visibility update
      ...
      Object.keys(restaurant.relevant_categories).forEach(category => {
          ...
          categoryBubble.style.padding = "4px 8px";
          categoryBubble.style.margin = "4px";
          categoryBubble.style.fontSize = "17px";
          ...
          if (typeof categoryValue === 'boolean') {
              ...
              categoryValue = categoryValue.toFixed(1); // Converts to string and rounds to 1 dp
      ...
      const reviewText = truncateText(restaurant.review, 300); // Truncate review to 300 characters max
